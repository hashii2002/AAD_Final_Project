...
public class VehicleController {
    ...
    public ResponseEntity<CommonResponse> saveVehicle(@RequestBody VehicleDTO vehicleDTO) {
    ...
    public ResponseEntity<CommonResponse> updateVehicle(@RequestBody VehicleDTO vehicleDTO) {
